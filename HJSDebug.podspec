...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/HiddenJester/HJSDebug"
  ...
  s.source       = { :git => "https://github.com/HiddenJester/HJSDebug.git", :tag => "v#{s.version}" }
  ...
  s.source_files  = "HJSDebug", "setbuildversion.sh"
  ...
  s.resource  = "HJSDebug/HJSDebugCenterControlPanel.xib"
